		...
		<form action = "AddAtmServlet" method = "POST" enctype="multipart/form-data" onsubmit="return checkForm(this);"> 
			<div class="container">
				...
				<div class="col-md-4">
					<div class="checkbox">
						<label for="c1"></label>
						<input type="checkbox" value="1" id="c1" name = "cassete1">Cassette 1 - 1000</input>
					</div>
					<div class="checkbox">
						<label for="c2"></label>
						<input type="checkbox" value="1" id="c2" name = "cassete2">Cassette 2 - 500</input>
					</div>
					<div class="checkbox">
						<label for="c3"></label>
						<input type="checkbox" value="1" id="c3" name = "cassete3">Cassette 3 - 500</input>
					</div>
					<div class="checkbox">
						<label for="c4"></label>
						<input type="checkbox" value="1" id="c4" name = "cassete4">Cassette 4 - 100</input>
					</div>
