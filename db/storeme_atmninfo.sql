...
CREATE TABLE `atmninfo` (
  ...
  `vendorCheckVerified` int(4) DEFAULT NULL,
  `deliveryCheckVerified` int(4) DEFAULT NULL,
  `warehouseCheckVerified` int(4) DEFAULT NULL,
